    ...
    <section class="my-5">
        <div id="pagina-principal" class="container">
            <div id="minhas-consultas" class="p-5 border">
                ...
                <span class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#listar-consultas-anteriores" role="button">Consultas passadas (<span class="n-consultas-anteriores">0</span>)  &raquo;</span>
                <hr>
