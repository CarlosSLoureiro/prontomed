...
class CadastrarAct {
    ...
    public function executar(Medico $medico, array $dados) : Consulta {
        ...
        if ($consulta_em_conflito != null) throw new Exception('Você já possui uma consulta agendada para ' . DateUtils::getAsDate($consulta_em_conflito->data)->isoFormat(DateUtils::pt_BR) . '. Tente agendar para ' . ConsultaRepository::TEMPO_MEDIO_DA_CONSULTA . ' minutos antes ou após.');
